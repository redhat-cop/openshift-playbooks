...
NOTE: It is beyond the scope of this document for the creation of a custom link:https://docs.splunk.com/Splexicon\:Sourcetype[sourcetype] to perform advanced parsing of the data received.
