...
<md:EntityDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" cacheDuration="P7D" entityID="https://ip-1-70-104-171.dob1.bcpc.bloomberg.com/saml2">
 ...
 oxvJ8E0MK4C48pg=
    ...
    <md:SingleLogoutService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect" Location="https://ip-1-70-104-171.dob1.bcpc.bloomberg.com/saml2/logout"/>
    <md:AssertionConsumerService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST" Location="https://ip-1-70-104-171.dob1.bcpc.bloomberg.com/saml2/postResponse" index="0"/>
