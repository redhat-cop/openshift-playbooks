...
When building an API call in this form, its best to use an {docs_url}admin_guide/allocating_node_resources.html#system-resources-reported-by-node[example] that shows / highlights actual data, like the stats endpoint for a node.
