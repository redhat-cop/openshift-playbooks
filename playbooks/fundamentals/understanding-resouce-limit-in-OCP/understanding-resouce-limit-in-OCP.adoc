...
link:./structure-of-the-boot-process{outfilesuffix}[__Tip. Structure to the boot process__]
...
- link:./scenario_1{outfilesuffix}[Scenario 1 : Use cpuset hierachy creating folder /sys/fs/cgroup (scope mode)]
- link:./scenario_2{outfilesuffix}[Scenario 2 : Use conf file to set cpu/memory amount for limit  (service mode)]

*Give load to test limit*

- link:./scenario_3{outfilesuffix}[Scenario 3 : Limit Test]
...
- link:./scenario_4{outfilesuffix}[Scenario 4 : Set up slices like Kubernetes do]
