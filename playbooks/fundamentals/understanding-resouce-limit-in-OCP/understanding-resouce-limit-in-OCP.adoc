...
link:/playbooks/fundamentals/understanding-resouce-limit-in-OCP/structure-of-the-boot-process{outfilesuffix}[__Tip. Structure to the boot process__]
...
- link:/playbooks/fundamentals/understanding-resouce-limit-in-OCP/scenario_1{outfilesuffix}[Scenario 1 : Use cpuset hierachy creating folder /sys/fs/cgroup (scope mode)]
- link:/playbooks/fundamentals/understanding-resouce-limit-in-OCP/scenario_2{outfilesuffix}[Scenario 2 : Use conf file to set cpu/memory amount for limit  (service mode)]

*Give load to test limit*

- link:/playbooks/fundamentals/understanding-resouce-limit-in-OCP/scenario_3{outfilesuffix}[Scenario 3 : Limit Test]
...
- link:/playbooks/fundamentals/understanding-resouce-limit-in-OCP/scenario_4{outfilesuffix}[Scenario 4 : Set up slices like Kubernetes do]
