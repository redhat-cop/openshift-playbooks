...
This example is based on link:https://developers.redhat.com/blog/2015/09/21/controlling-resources-with-cgroups-for-performance-testing/[Fred article]
...
1:name=systemd:/fredslice.slice/fredunit.scope\
```
Move on link:./scenario_2{outfilesuffix}[Scenario 2 : Use conf file to set cpu/memory amount for limit  (service mode)]
