...
* link:https://docs.openshift.com/enterprise/3.1/creating_images/guidelines.html[Guidelines for Creating OpenShift Images]
* link:https://docs.openshift.com/enterprise/3.1/creating_images/custom.html[Building Custom S2I Builder Images]
