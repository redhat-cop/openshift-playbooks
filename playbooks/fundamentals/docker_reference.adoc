...
* link:{docs_url}creating_images/guidelines.html[Guidelines for Creating OpenShift Images]
* link:{docs_url}creating_images/custom.html[Building Custom S2I Builder Images]
