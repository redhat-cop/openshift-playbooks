...
The `osm_default_node_selector` Ansible settings determine the label that projects will use by default when placing pods on Application nodes. They are set to `region=primary` by default:
