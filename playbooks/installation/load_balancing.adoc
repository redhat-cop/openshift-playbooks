...
NOTE: Configuring an ELB in this way makes general GUI and API usage
work as expected for the user. Although, some of the more dynamic 
...
at the session-layer. Until Amazon supports this common protocol, 
we can only recommend using a HAProxy instance to do the load balancing.

INFO: More information here https://medium.com/@Philmod/load-balancing-websockets-on-ec2-1da94584a5e9
